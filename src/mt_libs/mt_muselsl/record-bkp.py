...
def save_eeg(new_samples, new_timestamps):
    global eeg_samples , timestamps
    eeg_samples = np.concatenate(eeg_samples,new_samples)
    timestamps = np.concatenate(timestamps,new_timestamps)
