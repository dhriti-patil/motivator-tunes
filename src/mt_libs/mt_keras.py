...
def CreateEmotionsModel(input_eeg_csv, plot_dir, inp_epochs=30):
    ...
    fft_data_all = input_eeg_csv.filter(regex=FFT_KEYWORD)
    ...
    le.fit(input_eeg_csv["label"])
    input_eeg_csv["label"] = le.transform(input_eeg_csv["label"])

    ####################################################################################

    num_classes = len(input_eeg_csv["label"].unique())
    print(num_classes)

    plt.bar(range(num_classes), input_eeg_csv["label"].value_counts())
    ...
    labels_list = [i for i in input_eeg_csv["label"]]
    ...
    def view_evaluated_eeg_plots(model):
        start_index = random.randint(10, len(input_eeg_csv))
